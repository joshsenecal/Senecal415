...
ASenecal415Projectile::ASenecal415Projectile() 
{
	...
	CollisionComp->OnComponentHit.AddDynamic(this, &ASenecal415Projectile::OnHit);		// set up a notification for when this component hits something blocking
...
void ASenecal415Projectile::BeginPlay() {
	Super::BeginPlay();
